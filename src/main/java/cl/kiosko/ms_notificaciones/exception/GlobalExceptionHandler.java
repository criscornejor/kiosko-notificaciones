package cl.kiosko.ms_notificaciones.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePlantillaNoEncontradaException(PlantillaNoEncontradaException ex) {
